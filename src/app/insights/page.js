  ...
  return (
    <div className="p-6">
      ...
      <Card className="mb-8">
        <CardHeader>
          <div className="flex items-center gap-2">
            <CardTitle>Lookalike Analysis of Current Members</CardTitle>
          </div>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-purple-50">
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-bold">Clinical Scores</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li>
                    <div className="text-sm font-medium">Average A1C</div>
                    <div className="text-lg font-bold">6.1%</div>
                  </li>
                  <li>
                    <div className="text-sm font-medium">Fasting Glucose</div>
                    <div className="text-lg font-bold">112 mg/dL</div>
                  </li>
                  <li>
                    <div className="text-sm font-medium">Average BMI</div>
                    <div className="text-lg font-bold">27.4</div>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-blue-50">
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-bold">Co-morbidities</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li>
                    <div className="text-sm font-medium">Hypertension</div>
                    <div className="text-lg font-bold">42%</div>
                  </li>
                  <li>
                    <div className="text-sm font-medium">Obesity</div>
            ...
            <Card className="bg-green-50">
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-bold">Engagement Insights</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li>
                    <div className="text-sm font-medium">Digital Platform Usage</div>
                  ...
                  <li>
                    <div className="text-sm font-medium">Regular Check-ins</div>
